...
public:
  ...
  ros::Subscriber sub_point_measurement_;          ///< Point stamped measurement subscriber
  ...
  ///
  /// \brief PointMeasurementCallback Point measurement callback
  /// \param meas
  ///
  ///  Converting the ROS message to MaRS data type and running the PositionMeasurementUpdate routine
  ///
  void PointMeasurementCallback(const geometry_msgs::PointStampedConstPtr& meas);
  ...
  // Sensor Updates
  ///
  /// \brief PositionMeasurementUpdate Position sensor measurement update routine
